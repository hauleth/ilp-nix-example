...
ilp-as alice accounts create bob \
    ...
    --ilp-over-http-url http://localhost:10100/accounts/alice/ilp \
...
ilp-as bob accounts create alice \
    ...
    --ilp-over-http-url http://localhost:10000/accounts/bob/ilp \
    --settle-threshold 500 \
    --min-balance -1000 \
    --settle-to 0 \
    --routing-relation Peer \
...
#     --ilp-over-http-incoming-token $charlie_pass \
#     --ilp-over-http-outgoing-token $bob_pass \
...
#     --ilp-over-http-incoming-token $bob_pass \
#     --ilp-over-http-outgoing-token $charlie_pass \
